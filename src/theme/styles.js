...
export const styles = StyleSheet.create({
  ...
  successBox: {
    ...
    padding: 12,
    borderWidth: 1,
    borderColor: "rgba(74,159,102,0.34)",
    borderRadius: 8,
    backgroundColor: colors.greenSoft,
  },
  successText: {
  ...
  secondaryActionButton: {
    ...
    gap: 6,
    borderWidth: 1,
    borderColor: "rgba(15,139,141,0.28)",
    borderRadius: 8,
    backgroundColor: colors.tealSoft,
  },
  secondaryActionText: {
  ...
  dangerActionButton: {
    ...
    gap: 6,
    borderWidth: 1,
    borderColor: "rgba(228,111,92,0.28)",
    borderRadius: 8,
    backgroundColor: colors.coralSoft,
  },
  dangerActionText: {
  ...
  modalBackdrop: {
    ...
    justifyContent: "center",
    padding: 24,
    backgroundColor: "rgba(23,32,39,0.42)",
  },
  confirmModal: {
    width: "100%",
    maxWidth: 360,
